export class GunMagazineSystem {
    ...
    set ammo(value) { this.gun.getComponent('magazine').ammo = value; }
    ...
    set storageAmmo(value) { this.gun.getComponent('magazine').storageAmmo = value; }
    fireCheck() {
        if (this.ammo === 0)
            return false;
        this.ammo--;
...
//# sourceMappingURL=GunMagazineSystem.js.map