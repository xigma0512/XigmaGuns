import { Bullets } from "../../../../declare/element/BulletTypes";
...
export class BulletSystem {
    ...
    spawnTrajectory(from, vec, dimension) {
        ...
        while (true) {
            ...
            if (distance++ < 5)
                continue;
            try {
                dimension.spawnParticle('xigmaguns:locus', currentPos);
            }
            catch {
                break;
            }
...
//# sourceMappingURL=BulletSystem.js.map